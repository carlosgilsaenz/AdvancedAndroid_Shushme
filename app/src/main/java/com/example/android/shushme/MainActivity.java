...
public class MainActivity extends AppCompatActivity implements
    ...
    private void refreshPlacesData(){
        ...
        while(cursor.moveToNext()){
            ...
            int index = cursor.getColumnIndex(PlaceContract.PlaceEntry.COLUMN_PLACE_ID);
        ...
        PendingResult<PlaceBuffer> placeResults = Places.GeoDataApi.getPlaceById(mGoogleClient
